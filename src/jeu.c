...
void jeu(SDL_Surface *ecran, etat *etat, hero *safwen, parameter *p, character c, background background, dialogue dial)
{
	...
	SDL_Surface *enigme_frames_4[10];

	enigme_frames_4[0] = IMG_Load("../img/enigme/icon/1.png");
	enigme_frames_4[1] = IMG_Load("../img/enigme/icon/2.png");
	enigme_frames_4[2] = IMG_Load("../img/enigme/icon/3.png");
	enigme_frames_4[3] = IMG_Load("../img/enigme/icon/4.png");
	enigme_frames_4[4] = IMG_Load("../img/enigme/icon/5.png");
	enigme_frames_4[5] = IMG_Load("../img/enigme/icon/6.png");
	enigme_frames_4[6] = IMG_Load("../img/enigme/icon/7.png");
	enigme_frames_4[7] = IMG_Load("../img/enigme/icon/8.png");
	enigme_frames_4[8] = IMG_Load("../img/enigme/icon/9.png");
	enigme_frames_4[9] = IMG_Load("../img/enigme/icon/10.png");

	int now = 0;
	int then = 0;

	SDL_Rect pos_enigme1, pos_enigme2, pos_enigme3, pos_enigme4;
	...
	SDL_Rect posss1, posss2, posss3,posss4;
	...
	while (Jcontinuer)
	{
		...
		if (safwen->position.x <= 3410 && safwen->position.x >= 3450 && safwen->position.y <= 1330 && !once_fcp)
		{
		...
		//enigme Pendu
		if (safwen->position.x <= 6800 && safwen->position.x >= 6780 && safwen->position.y <= 2220 && !once_enigme_pendu)
		{
		...
		//AI
		if (safwen->position.x >= 6750 && safwen->position.x <= 6770 && safwen->position.y <= 720 && !once_enigme_AI)
		{
		...
		posss4.x = pos_enigme4.x - background.posCamera.x;
		posss4.y = pos_enigme4.y - background.posCamera.y;


		if (once_fcp != 1)
			SDL_BlitSurface(enigme_frames_1[en_frame], NULL, ecran, &posss1);
		if (once_enigme_pendu != 1)
			SDL_BlitSurface(enigme_frames_2[en_frame], NULL, ecran, &posss3);
		if (once_enigme_AI != 1)
			SDL_BlitSurface(enigme_frames_3[en_frame], NULL, ecran, &posss4);
		if (once_enigme_math != 1)
			SDL_BlitSurface(enigme_frames_3[en_frame], NULL, ecran, &posss2);
